...
#' @param DIFVar Name of DIF variable for DIF analysis. Default is NULL. When a name is provided, a folder with that name will be created under 'DIF' folder to hold DIF analysis output files and analysis results.
#' @export
