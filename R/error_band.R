#' error_band
#'
#' This function produces smoothed upper and lower confidence interval (CI) values of the average of an item's delta estimates in two tests. Those values will be used in plotting.
