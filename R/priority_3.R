#' priority_3
#'
#' This function checks response option point biserial (Pt Bis) values in 'test.itn' file in 'output' folder and flag items with any distractor of positive Pt Bis. This is associated with test named 'test'.
#'
